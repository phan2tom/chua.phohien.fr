...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'dream' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'dream' ),
		'repeat-y'  => __( 'Repeat Vertically', 'dream' ),
		'repeat'    => __( 'Repeat All', 'dream' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'dream' ),
		'top center'    => __( 'Top Center', 'dream' ),
		'top right'     => __( 'Top Right', 'dream' ),
		'center left'   => __( 'Middle Left', 'dream' ),
		'center center' => __( 'Middle Center', 'dream' ),
		'center right'  => __( 'Middle Right', 'dream' ),
		'bottom left'   => __( 'Bottom Left', 'dream' ),
		'bottom center' => __( 'Bottom Center', 'dream' ),
		'bottom right'  => __( 'Bottom Right', 'dream')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'dream' ),
		'fixed'  => __( 'Fixed in Place', 'dream')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'dream' ),
		'italic'      => __( 'Italic', 'dream' ),
		'bold'        => __( 'Bold', 'dream' ),
		'bold italic' => __( 'Bold Italic', 'dream' )
		);
