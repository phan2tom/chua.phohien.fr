...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
				printf( _nx( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'dream' ),
		...
		<nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
			<h2 class="screen-reader-text"><?php _e( 'Comment navigation', 'dream' ); ?></h2>
			<div class="nav-links">

				<div class="nav-previous"><?php previous_comments_link( __( 'Older Comments', 'dream' ) ); ?></div>
				<div class="nav-next"><?php next_comments_link( __( 'Newer Comments', 'dream' ) ); ?></div>
	...
	?>
		<p class="no-comments"><i class="fa fa-exclamation-circle"></i> <?php _e( 'Comments are closed.', 'dream' ); ?></p>
	<?php endif; ?>
...
$comments_args = array(
	...
	'cancel_reply_link'    => '<i class="fa fa-close"></i> '.__( 'Cancel reply','dream' )
);
